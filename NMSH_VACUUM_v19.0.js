...
(function () {
    ...
    function initMain(){
        ...
        function buildPanel(){
            ...
            '</div>' +
            '<div class="mrp-row" style="margin-bottom:8px">' +
                '<div class="mrp-f"><label class="lbl">Min $ (protect queue)</label><input class="inp" id="mrp-min-reward" value="' + state.minReward.toFixed(2) + '" placeholder="0.00"></div>' +
            '</div>';
        ...
        function bindEvents(){
            ...
            chg('mrp-min-reward', function(v){ state.minReward = Math.max(0, parseFloat(v) || 0); var e = gel('mrp-min-reward'); if (e) e.value = state.minReward.toFixed(2); saveState(); });
